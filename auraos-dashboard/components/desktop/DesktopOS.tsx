...
import { WindowManagerProvider } from "@/components/layout/WindowManager"
import { DesktopIcon } from "@/components/desktop/DesktopIcon"
import { QuantumWallpaper } from "@/components/desktop/QuantumWallpaper"
import { AINotesApp } from "@/components/apps/AINotesApp"
import { AICodeEditorApp } from "@/components/apps/AICodeEditorApp"
import { AIFileManagerApp } from "@/components/apps/AIFileManagerApp"
import { AITerminalApp } from "@/components/apps/AITerminalApp"
import { AIAutomationApp } from "@/components/apps/AIAutomationApp"
import { AIAutopilotApp } from "@/components/apps/AIAutopilotApp"
...
import {
  ...
  AIAssistantIcon,
  SettingsIcon,
} from "@/components/desktop/AppIcons"
  ...
  return (
    <WindowManagerProvider>
      <div className="relative h-screen w-screen overflow-hidden bg-[#0a0a0f]">
        ...
        {/* Start Menu */}
        <AnimatePresence>
          {startMenuOpen && <StartMenu onClose={() => setStartMenuOpen(false)} onOpenApp={handleIconDoubleClick} />}
        </AnimatePresence>
